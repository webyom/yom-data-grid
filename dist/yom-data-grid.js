        ...
        (function() {
            ...
            if (column.type == "checkbox") {
                ...
                if (column.headerRenderer) {
                    ...
                    columnHeader += '<a class="yom-data-grid-sortable" href="javascript:void(0);" onclick="return false" title="' + $encodeHtml(column.name) + '">' + column.name + "" + (sortColumnId == column.id ? sortOrder == "desc" ? '<span class="yom-data-grid-sort-arrow yom-data-grid-sort-arrow-down"></span>' : '<span class="yom-data-grid-sort-arrow yom-data-grid-sort-arrow-up"></span>' : '<span class="yom-data-grid-sort-arrow"></span>') + "</a>";
                } else {
                    columnHeader += '<span title="' + $encodeHtml(column.name) + '">' + column.name + "</span>";
                }
                if (filterable) {
